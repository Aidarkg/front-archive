...
export const CustomButton = ({ text, icon, to, onClick, actionType, buttonStyle, type, style, disabled, className, target, rel, isBig, isBanner}) => {
    ...
    return (
        <ButtonComponent disabled={disabled} {...typeProps} className={`${classes.customButton} ${buttonClassName} ${isBig? classes.mainButton: ""} ${isBanner? classes.bannerBtn : ""}`} style={style}>
