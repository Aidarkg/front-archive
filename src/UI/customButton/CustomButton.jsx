...
export const CustomButton = ({ text, icon, to, onClick, actionType, buttonStyle, type, style, disabled, className, target, rel, isMainGallery}) => {
    ...
    return (
        <ButtonComponent disabled={disabled} {...typeProps} className={`${classes.customButton} ${buttonClassName} ${isMainGallery? classes.mainButton: ""} `} style={style}>
